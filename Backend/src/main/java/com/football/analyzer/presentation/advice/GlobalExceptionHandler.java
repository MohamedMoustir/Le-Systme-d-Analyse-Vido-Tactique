package com.football.analyzer.presentation.advice;


import com.football.analyzer.domain.exception.*;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> DuplicateResourceException(DuplicateResourceException ex, HttpServletRequest request) {
    ...
    public ResponseEntity<Map<String, Object>> handlePaymentRequiredException(PaymentRequiredException ex, HttpServletRequest request) {
        logger.warn("Payment required: {}", ex.getMessage());
